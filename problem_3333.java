...
Please note that this solution assumes that the input string `word` consists only of lowercase English letters and the value of `k` is within the given constraints.*public class problem_3333 */
